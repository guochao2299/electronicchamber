...
public class CommentAdd extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		comment.setContent(new String(content.getBytes("ISO-8859-1")));
		comment.setUserAccount(new String(author.getBytes("ISO-8859-1")));
		...
		{
			request.setAttribute("result", "Sorry,添加评论失败");
